...
from smart_ai.channels.base_channel import InputChannel, UserMessage

if TYPE_CHECKING:
    from smart_ai.core.tracker import DialogueStateTracker
    from smart_ai.agent.message_processor import MessageProcessor
