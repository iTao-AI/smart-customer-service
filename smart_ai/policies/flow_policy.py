...
from smart_ai.dialogue_understanding.flow import FlowExecutor, FlowsList
from smart_ai.dialogue_understanding.stack.stack_frame import FlowStackFrame
...
class FlowPolicy(Policy):
    ...
    def _preset_slot_to_collect_if_needed(
        ...
        # 检查下一步是否是 collect 步骤
        from smart_ai.dialogue_understanding.flow.flow import StepType
