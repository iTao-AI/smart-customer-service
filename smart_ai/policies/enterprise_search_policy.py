...
from smart_ai.policies.base_policy import Policy, PolicyConfig, PolicyPrediction
from smart_ai.shared.constants import DegradationReason, ACTION_DEFAULT_FALLBACK
from smart_ai.shared.llm import create_llm_client
from smart_ai.shared.llm.base_client import LLMClient
from smart_ai.retrieval.base_retriever import SearchResult

if TYPE_CHECKING:
    from smart_ai.core.tracker import DialogueStateTracker
    from smart_ai.core.domain import Domain
    from smart_ai.dialogue_understanding.flow import FlowsList
    from smart_ai.dialogue_understanding.stack.stack_frame import StackFrame
...
"""
    ...
    def does_support_stack_frame(self, frame: Optional[Any] = None) -> bool:
        ...
        Returns:
            是否支持处理该栈帧
        """
        from smart_ai.dialogue_understanding.stack.stack_frame import (
            SearchStackFrame,
            ChitChatStackFrame,
