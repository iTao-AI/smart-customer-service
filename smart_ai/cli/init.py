...
from smart_ai.shared.constants import (
    DEFAULT_CONFIG_PATH,
    DEFAULT_DATA_PATH,
    DEFAULT_DOMAIN_PATH,
    DEFAULT_MODELS_PATH,
...
# 默认的config.yml内容
DEFAULT_CONFIG_CONTENT = '''# SmartAI AI 配置文件
# LLM驱动的对话系统配置
...
responses:
  utter_greet:
    - text: "你好！我是SmartAI AI助手，有什么可以帮助你的吗？"
    - text: "您好！很高兴为您服务。"
...
from smart_ai.agent.actions import Action, ActionResult
    ...
    async def run(
        ...
        **kwargs: Any,
        ...
        if user_name:
            ...
            result.add_response("你好！我是SmartAI AI助手，有什么可以帮助你的吗？")
        return result
...
# README内容
DEFAULT_README_CONTENT = '''# SmartAI AI 项目
...
def init_command(
    ...
    示例:
        smrt init                    # 在当前目录初始化
        smrt init --path ./my_bot    # 在指定目录初始化
        smrt init --template basic   # 使用basic模板
    """
    click.echo("欢迎使用 SmartAI AI!\n")
    click.echo("正在创建新项目...\n")
    ...
    try:
        ...
        click.echo("  3. 运行 'smrt train' 训练模型")
        click.echo("  4. 运行 'smrt shell' 测试对话")
        click.echo("")
