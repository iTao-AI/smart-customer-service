...
def export_command(
    ...
    示例:
        smrt export --output ./export/model.tar.gz
        smrt export --format zip --output ./export/model.zip
        smrt export --format json --output ./export/domain.json
    """
