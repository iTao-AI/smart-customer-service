...
class ConfigurationException(SmartAIException):
    """配置异常
...
class ModelNotFound(SmartAIException):
    """模型未找到异常
...
class ModelLoadException(SmartAIException):
    """模型加载异常
...
class ModelTrainingException(SmartAIException):
    """模型训练异常
...
class LLMException(SmartAIException):
    """LLM异常基类
...
class TrackerStoreException(SmartAIException):
    """Tracker存储异常基类
...
class DialogueUnderstandingException(SmartAIException):
    """对话理解异常基类
...
class ActionException(SmartAIException):
    """Action异常基类
...
class ChannelException(SmartAIException):
    """通道异常基类
...
class GraphException(SmartAIException):
    """图引擎异常基类
...
class RetrievalException(SmartAIException):
    """检索异常基类
...
class ValidationException(SmartAIException):
    """验证异常基类
