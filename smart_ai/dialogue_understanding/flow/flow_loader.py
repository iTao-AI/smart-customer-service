...
from smart_ai.dialogue_understanding.flow.flow import Flow, FlowsList
from smart_ai.shared.yaml_loader import read_yaml_file, read_yaml_files
from smart_ai.shared.exceptions import ConfigurationException
...
class FlowLoader:
    ...
    def load_from_string(self, yaml_string: str) -> FlowsList:
        ...
        Returns:
            FlowsList实例
        """
        from smart_ai.shared.yaml_loader import read_yaml_string
